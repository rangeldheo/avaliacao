...
return [
    ...
    */
    ...
    'price' => 'O campo :attribute eve ser um valor em dinheiro.',
    ...
    */
    ...
    'custom' => [
        ...
        'start_service' => [
            'after' => 'O campo horário do atendimento deve ser uma data posterior a atual.',
        ],
        'start_interval' => [
            'date_format' => 'O campo :attribute não corresponde ao formato Horas:minutos (00:00)',
        ],
        'end_interval' => [
            'date_format' => 'O campo :attribute não corresponde ao formato Horas:minutos (00:00)',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'document'  => 'documento',
        'excerpt'   => 'resumo',
        'end_service' => 'horário final do atendimento',
        ...
        'state'     => 'estado',
        'street'    => 'rua',
        'start_service' => 'horário inicial do atendimento',
        'subject'   => 'assunto',
        'text'      => 'texto',
        'time'      => 'hora',
        'title'     => 'título',
        ...
        /**
         * ------------------------------------------------
         * Alias personalizados para validação
         * ------------------------------------------------
         */
        'company'          => 'empresa',
        ...
        'end'              => 'horário final',
        'start_interval'   => 'início do intervalo',
        'end_interval'     => 'final do intervalo',
